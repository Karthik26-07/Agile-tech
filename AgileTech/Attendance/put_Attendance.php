...
function firsthalf(){
    ...
    if($first_half_time<="09:30:00"){
      ...
      $sql = "insert into attendance(user_id,date,first_half,first_half_time,second_half,second_half_time)"
              . "values ('$Id','$Date','$first_half','$first_half_time','$second_half','$second_half_time')";
