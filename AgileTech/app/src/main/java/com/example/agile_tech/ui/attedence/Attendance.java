    ...
    private void sendlocation(String latitude, String longitude) {
        ...
        loc.enqueue(new Callback<DataModal>() {
            ...
            public void onResponse(@NonNull Call<DataModal> call, @NonNull Response<DataModal> response) {
                Toast.makeText(getContext(), "Put your attendance at now", Toast.LENGTH_SHORT).show();

                next.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {

                        if (response.body().response.equals("Near to the location")) {
                            Call<DataModal> attendance = retrofit.put_Attendance();
                            ...
                            Toast.makeText(getContext(), "Not near to the location", Toast.LENGTH_SHORT).show();
